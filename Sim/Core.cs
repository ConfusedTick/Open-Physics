...
namespace Sim
{
    ...
    public class Core
    {
        ...
        public static void InitializeGameStart(Size size)
        {
            ...
            ParticleBase bs = ParticleFactory.GetFactory(Map).AddNewParticle(ParticleIds.WATER, new ParticlePositionParameters(10, 10), Flags.Empty);
            ParticleFactory.GetFactory(Map).AddNewInstrument((int)ParticleIds.HEATSOURCE, bs, Flags.Empty, +1000000d);
